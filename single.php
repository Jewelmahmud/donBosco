...
<section class="single-news-body contents">
    <div class="container">
        ...
        <div class="share-news">
            ...
            <ul class="social-icon-wrapper">
                ...
                <li>
                    <a href="https://www.instagram.com/share?url=<?php echo urlencode(get_permalink()); ?>"  target="_blank">
                ...
                <!-- Add other social share buttons similarly -->
            </ul>
        </div>
        <?php
        // End the loop
