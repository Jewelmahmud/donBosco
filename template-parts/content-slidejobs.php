...
<div class="swiper-slide">
    <div class="vacancies-card-item">
        <div>
            <button type="button" class="btn-fav <?php echo $is_favorite ? 'active' : ''; ?>" data-id="<?php echo get_the_ID(); ?>" onclick="addFavourite(this)" data-id="<?php echo get_the_ID(); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="21"
