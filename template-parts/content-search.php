...
<div class="vacancies-card-item">
    ...
    <div class="top">    
        ...
        <p><?php echo (get_the_excerpt())? limitWords(strip_tags(get_the_excerpt()), 7) : __('Click below details link to get more of this item', 'donbosco') ?></p>
    </div>
    <!-- <div class="bottom">
        <ul>
            <li>
            ...
            <li>
                <span>
                    ...
                    <?php echo __('Created at', 'donbosco'); ?>
                </span>
    ...
    <a href="<?php the_permalink(); ?>" class="link-btn"><?php echo __('View details', 'donbosco'); ?> <svg xmlns="http://www.w3.org/2000/svg" width="7" height="10"
