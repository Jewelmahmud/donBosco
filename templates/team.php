        ...
        <div class="row mx-0">
          <div class="col-md-7 p-4 p-lg-5 order-2 order-md-0 modal-texts">
            ...
            <div class="d-flex align-items-center gap-2 mb-2">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon-mobile.svg" alt="icon-mobile"> <a class="modalphone" href="tel:0627057799">06 - 27 05 77 99</a>
            </div>
            <div class="d-flex align-items-center gap-2 mb-2">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon-envelope.svg" alt="icon-envelope"> <a class="modalemail" href="mailto:f.kilic@donboscoapeldoorn.nl">f.kilic@donboscoapeldoorn.nl</a>
            </div>
