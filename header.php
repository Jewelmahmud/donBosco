...
<body <?php body_class(); ?>>
  ...
  <div class="bg-home-top" style="background-image: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(<?php echo $banner; ?>);">
    <header class="header">
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          ...
          <div class="offcanvas offcanvas-top" id="main-nav" tabindex="-1" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
              ...
              <div class="d-flex align-items-center gap-2">
                <?php $link = get_field('header_action_button', 'option');
                if ($link) : ?>
    ...
    <?php if (is_home() || is_front_page()) : 
      ...
      $activity = $hero['activiteiten']['display_events'];
      $verhuurs = $hero['activiteiten']['display_verhuur']; ?>

      <section class="banner-home <?php if (!$hero['display_donation']) echo 'home-padding'; ?>">
        <div class="container" <?= (!$activity && !$verhuurs)? 'style="padding-bottom: 6rem;"': ''; ?>>
          <div class="row">
          ...
          if ($activity || $verhuurs) : ?>
            <?php if ($events->have_posts() || $verhuur->have_posts()) : ?>
              <div class="activity-tabs <?php if (!$hero['display_donation']) echo 'activity-margin'; ?>">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                  <?php if ($activity) : ?>
                    <?php if ($events->have_posts()) : ?>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link <?php if ($activity && $verhuurs) echo 'active'; ?>" id="event-tab" data-bs-toggle="tab" data-bs-target="#event" type="button" role="tab" aria-controls="event" aria-selected="true">Event</button>
                      </li>
                    <?php endif; ?>
                  <?php endif; ?>
                  <?php if ($verhuurs) : ?>
                    <?php if ($verhuur->have_posts()) : ?>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link  <?php if (!$verhuurs && $activity) echo 'active'; ?>" id="verhuur-tab" data-bs-toggle="tab" data-bs-target="#verhuur" type="button" role="tab" aria-controls="verhuur" aria-selected="false">Verhuur</button>
                      </li>
                    <?php endif; ?>
                  <?php endif; ?>
                </ul>
            ...
            <?php if ($events->have_posts() || $verhuur->have_posts()) : ?>              
              ...
              <?php if ($verhuurs) : ?>
              <?php if ($verhuur->have_posts()) : ?>
                <div class="tab-pane fade <?php if ($verhuurs && !$activity) echo 'show active'; ?>" id="verhuur" role="tabpanel" aria-labelledby="verhuur-tab">
                  <div class="row align-items-center">
                    <div class="col-lg-3">
          ...
          <div class="container">
            ...
            <div class="mt-4">
              <div class="d-flex align-items-center gap-5">
                ...
                <a class="go-back d-flex align-items-center gap-3" href="javascript:void(0);" onclick="history.back();">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 mb-5 mb-lg-0">
              <?php $hipen =  (get_field('end_date'))? '-' : ''; ?>
              <div class="event-date">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon-calendar-w.svg" alt="icon-calendar"> <?php echo !is_singular('fk_verhuur') ? get_field('start_date') . ' '.$hipen.' ' . get_field('end_date') : get_the_date(); ?>
              </div>
              <h1><?php the_title(); ?></h1>
              <?php if (!is_singular('fk_verhuur')) : ?>
                <?php if(get_field('start_time')):?>
                <div class="event-time">
                  <?php $hipen =  (get_field('end_time'))? '-' : ''; ?>
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon-clock.svg" alt="clock"><?php echo get_field('start_time') . ' '.$hipen.' ' . get_field('end_time'); ?>
                </div>
                <?php endif; ?>
              <?php endif; ?>
              <?php if (!is_singular('fk_verhuur')) : ?>
            ...
            <div class="col-lg-5 col-xl-4 offset-lg-1 offset-xl-2">
              <?php $totals = get_field('event_statistics');
              if ($totals) :  ?>
